...
TokenMeter は Codex、Cursor、DeepSeek、Xiaomi MiMo、NayutoAI に対応した、軽量な Windows デスクトップ用 AI 使用量モニターです。
...
本体 `1.14.2`、任意のペット拡張 `0.1.0`。変更履歴とチェックサムは [GitHub Releases](https://github.com/zensoku142/TokenMeter/releases) にあります。
