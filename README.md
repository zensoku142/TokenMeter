...
TokenMeter 是轻量级 Windows 桌面 AI 用量监控工具，支持 Codex、Cursor、DeepSeek、Xiaomi MiMo 与 NayutoAI。
...
主程序 `1.14.0`，可选桌宠扩展 `0.1.0`。更新记录与校验文件见 [GitHub Releases](https://github.com/zensoku142/TokenMeter/releases)。
