...
当前版本：**v1.15.1** · 桌宠扩展 **v0.1.4** · [产品官网（GitHub Pages）](https://zensoku142.github.io/TokenMeter/)
...
- 主程序 v1.15.1 配合桌宠 v0.1.4，可同步额度气泡与独立额度窗口的明暗底色、文字和低额度提示色；旧版仍可连接。
...
主程序 `1.15.1`，可选桌宠扩展 `0.1.4`。更新记录与校验文件见 [GitHub Releases](https://github.com/zensoku142/TokenMeter/releases)。
