...
DEFAULT_CONFIG: dict[str, Any] = {
    ...
    "QUOTA_FORECAST_ENABLED": False,
    "QUOTA_RECOVERY_ALERT_ENABLED": False,
    "QUOTA_QUIET_ENABLED": False,
    "QUOTA_QUIET_START": "22:00",
    "QUOTA_QUIET_END": "08:00",
...
FIELD_META: dict[str, dict[str, Any]] = {
    **{key: {"kind": "text", "secret": key in SECRET_KEYS} for key in DEFAULT_CONFIG},
    ...
    "QUOTA_FORECAST_ENABLED": {"kind": "bool"},
    "QUOTA_RECOVERY_ALERT_ENABLED": {"kind": "bool"},
    "QUOTA_QUIET_ENABLED": {"kind": "bool"},
    "QUOTA_QUIET_START": {"kind": "time"},
    "QUOTA_QUIET_END": {"kind": "time"},
