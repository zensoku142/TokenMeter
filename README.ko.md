...
현재 버전：**v1.15.1** · VPet **v0.1.4** · [GitHub Pages](https://zensoku142.github.io/TokenMeter/)
...
- **데스크톱 표시**: 드래그, 휠 크기 조절, 가장자리 숨김, 트레이, 라이트·다크·시스템 테마, 색상과 투명도, 5개 언어, 자동 업데이트와 선택적 VPet을 제공합니다. 앱 v1.15.1과 펫 v0.1.4를 함께 사용하면 한도 창 테마가 동기화됩니다.
...
메인 앱 `1.15.1`, 선택적 펫 확장 `0.1.4`. 변경 기록과 체크섬은 [GitHub Releases](https://github.com/zensoku142/TokenMeter/releases)에서 확인하세요.
